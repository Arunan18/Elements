...
public class RadioButtonsTest1 extends DriverInitialization{
...
//		Calibrated Type Heading
		...
		try {
			if (RadioButtonsPage.InternalRadioButton.isDisplayed() && RadioButtonsPage.ExternalRadioButton.isDisplayed()) {
//				Internal Radio Button Visible
				...
				testCase = extent.createTest(RadioButtonsPage.InternalRadioButtonWithText.getText()+" RADIO BUTTON VISIBLE");
				try {
...
//				External Radio Button Visible
				...
				testCase = extent.createTest(RadioButtonsPage.ExternalRadioButtonWithText.getText()+" RADIO BUTTON VISIBLE");
				try {
...
//				Check internal border colour 
				...
				testCase = extent.createTest("ONE OF THE RADIO BUTTON NOT VISIBLE");
				testCase.log(Status.FAIL, "Not visible radio button. so fail");
			}
		} catch (NoSuchElementException e) {
			testCase = extent.createTest("DONT HAVE RADIO BUTTON LOCATOR");
			testCase.log(Status.FAIL, "DONT HAVE RADIO BUTTON LOCATOR");
		}
}
}
