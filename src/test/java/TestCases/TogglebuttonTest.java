...
//			TogglebuttonPage.testcongichomebutton.click();
		...
		String ExpectedColour = "rgba(0, 0, 0, 0.25)";
		boolean colour = true;
		...
		boolean ActualButtonEnable = TogglebuttonPage.Duedaytoggle.isEnabled();
		testCase = extent.createTest("TOGGLE BUTTON ENABLE");
		try {
			Assert.assertEquals(ActualButtonEnable, ExpectedButtonEnable);
			testCase.log(Status.INFO, "Actual Button Visible :- " + ActualButtonEnable);
			testCase.log(Status.INFO, "Expected Button Visible :- " + ExpectedButtonEnable);
			testCase.log(Status.PASS, "Button Visible is Correct");
		} catch (AssertionError e) {
			testCase.log(Status.INFO, "Actual Button Visible :- " + ExpectedButtonEnable);
			testCase.log(Status.INFO, "Expected Button Visible :- " + ExpectedButtonEnable);
...
//							      ******************toggle switch function confirm****************
		...
		try {
			...
			TogglebuttonPage.Duedaytoggle.click();
			String afterClickBgColor = TogglebuttonPage.Duedaytoggle.getCssValue("background-color");
			boolean highlight = true;
			testCase = extent.createTest("TOGGLE BUTTON FUNCTION");
			try {
